<template>
  <div>
    ...
    <div v-if="!customDacData">
      ...
      <p class="subtitle-step margin-bottom-15">{{ step1.tokenSymbol }}</p>
...
import CustomDivider from "components/steps/Step3/CustomDivider";

export default {
  data() {
    const factoryData = this.$store.state.factory.stepsData;
